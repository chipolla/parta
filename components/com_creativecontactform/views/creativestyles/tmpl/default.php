...
$id_form = isset($_GET['id_form']) ? (int)$_GET['id_form'] : 0;
	...
	$query = 
				...
				'FROM '.
					'`#__creative_forms` sp '.
				'LEFT JOIN '.
					'`#__contact_templates` st ON st.id = sp.id_template ';
	$query .=
				'WHERE sp.published = \'1\' AND sp.id = \''.$id_form.'\' ';

	$db->setQuery($query);
	$styles_value = $db->loadResult();
...
.ccf_static_button_<?php echo $id_form;?>.ccf_static_button,
.ccf_popup_button_<?php echo $id_form;?>.ccf_popup_button
 {
...
.ccf_static_button_<?php echo $id_form;?>.ccf_static_button:hover,
.ccf_static_button_<?php echo $id_form;?>.ccf_static_button:active, 
.ccf_static_button_<?php echo $id_form;?>.ccf_static_button:focus,
.ccf_static_button_<?php echo $id_form;?>.ccf_static_button.ccf_static_button_opened,

.ccf_popup_button_<?php echo $id_form;?>.ccf_popup_button:hover,
.ccf_popup_button_<?php echo $id_form;?>.ccf_popup_button:active, 
.ccf_popup_button_<?php echo $id_form;?>.ccf_popup_button:focus
...
.ccf_popup_link_<?php echo $id_form;?>
 {
...
.ccf_popup_link_<?php echo $id_form;?>:hover
 {
