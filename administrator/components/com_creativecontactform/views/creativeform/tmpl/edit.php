...
foreach($this->form->getFieldset() as $field): ?>
		...
		<?php if($qq == 17) echo '<a style="float: none;margin-top: 0px;clear:both;" href="http://creative-solutions.net/joomla/creative-contact-form/demo" target="_blank">See Templates Demo</a>'; ?>
	...
	<?php }?>
	<?php if($qq == 29) {?>
		<h3 style="margin-bottom: 20px;margin-top: 25px;">Send Copy Options</h3>
	<?php }?>
	<?php if($qq == 31) {?>
		<h3 style="margin-bottom: 20px;margin-top: 25px;">Shake Effect Options</h3>
	<?php }?>
	<?php if($qq == 34) {?>
		<h3 style="margin-bottom: 20px;margin-top: 25px;">User Info Options</h3>
	<?php }?>
	<?php if($qq == 39) {?>
		<h3 style="margin-bottom: 20px;margin-top: 25px;">Custom Styling</h3>
	<?php }?>
<?php $qq ++;
endforeach; ?>
		</ul>
						...
						<div class="control-group">
							...
							foreach($this->form->getFieldset() as $field): ?>
								<div class="control-label">
									<?php echo $field->label;?>
									<?php if($qq == 17) echo '<a style="float: left;margin-top: 0px;clear:both;" href="http://creative-solutions.net/joomla/creative-contact-form/demo" target="_blank">See Templates Demo</a>'; ?>
